...
func newTestServerWithConfig(t *testing.T, configure func(*proxyconfig.Config)) *Server {
	t.Helper()
	return newTestServerWithOptionsAndConfig(t, configure)
}

func newTestServerWithOptions(t *testing.T, opts ...ServerOption) *Server {
	t.Helper()
	return newTestServerWithOptionsAndConfig(t, nil, opts...)
}

func newTestServerWithOptionsAndConfig(t *testing.T, configure func(*proxyconfig.Config), opts ...ServerOption) *Server {
	t.Helper()
