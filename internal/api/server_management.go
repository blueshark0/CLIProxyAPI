...
func (s *Server) serveManagementControlPanel(c *gin.Context) {
	...
	// Prefer an external asset when one is configured or already on disk; the
	// compile-time embedded panel is the self-contained fallback. No runtime
	// download or background updater is involved.
